...
describe 'Invoices API' do
  ...
  context 'get request to /api/v1/invoice_items' do
    it 'responds with a list of all invoice_items' do
  ...
  describe 'invoice_item single finders' do
    ...
    it 'finds one invoice by unit_price' do
      ...
      expect(invoice_items["unit_price"]).to eq(Money.new(@invoice_items[0].unit_price, "USD").to_s)
    end
    ...
    it 'finds one invoice by quantity' do
  ...
  describe 'invoice multiple finders' do
    it 'finds all invoice_items with specific id' do
    ...
    it 'finds all invoice_items with specific invoice_id' do
    ...
    it 'finds all invoice_items with specific item_id' do
    ...
    it 'finds all invoice_items with specific quantity' do
